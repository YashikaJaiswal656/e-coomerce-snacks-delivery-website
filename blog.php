                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            ?>
                            <li><a href="#"><?php echo $row['category_2']?></a></li>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <h5><a href="#">Short Details</a></h5>
                                    <p> <?php echo $roww['detail']?></p>
                                    <a href="blog-details.php?id=<?php echo $roww['id']?>" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <?php }?>
